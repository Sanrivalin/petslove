    ...
    <div class="col-xs-12 sln-row">
        ...
        <div class="col-xs-12 col-sm-6 sln-select">
            <select id="sln-update-user-field"
                 ...
                 data-placeholder="<?php _e('Start typing the name or email or phone number', 'salon-booking-system')?>"
                 class="form-control">
            </select>
        </div>
        <?php if ($plugin->getSettings()->get('enable_customer_fidelity_score')): ?>
            <div class="col-xs-12 col-sm-2">
                <div class="sln-booking-customer-score">
                    <div class="sln-booking-customer-score--title">
                        <?php _e('Score', 'salon-booking-system') ?>
                    </div>
                    <div class="sln-booking-customer-score--value">
                        <?php echo $booking->getCustomer() ? $booking->getCustomer()->getFidelityScore() : 0 ?>
                    </div>
                </div>
            </div>
        <?php endif ?>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-3 sln-input--simple">
                    ...
                    <?php echo $booking->getTransactionId() ?
                        '<h5 class="sln-box-title--nu--ter sln-box-title--nu--dark">' . __("Transaction", 'salon-booking-system') . ': <strong>' . implode(', ', $booking->getTransactionId()) . '</strong></h5>' :
                ...
                <?php SLN_Form::fieldText($helper->getFieldName($postType, 'paid_remained_amount'), $booking->getPaidRemainedAmount(),
                [
                    'type' => 'hidden',
                ]);?>
